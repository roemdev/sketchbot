...
const SILENT_MENTIONS = { allowedMentions: { parse: [] } };
...
async function sendTestLogs(client, targetChannel) {
  ...
  await channel.send({ components: [joinContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
  ...
  await channel.send({ components: [leaveContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);

  // 3. Ganancia de Casino
  const winContainer = new ContainerBuilder()
    .setAccentColor(2067276)
    .addTextDisplayComponents(t => t.setContent(`💰 **<@123456789012345678>** ganó **${COIN}500,000** en **Blackjack**.`));
  await channel.send({ components: [winContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
  ...
  await channel.send({ components: [lossContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
  ...
  await channel.send({ components: [workContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
  ...
  await channel.send({ components: [epicContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
  ...
  await channel.send({ components: [legendaryContainer], flags: MessageFlags.IsComponentsV2, ...SILENT_MENTIONS }).catch(console.error);
}
