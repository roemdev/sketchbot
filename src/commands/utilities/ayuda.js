  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: ' ', value: '**Rol VIP**: <:check:1313237490395648021>', inline: true  }
      );
        ...
        case 'music':
          ...
          case 'vip':
            responseEmbed = new EmbedBuilder()
              .setColor(assets.color.base)
              .setTitle('⭐ VIP')
              .setDescription('El rol <@&1303816942326648884> te ofrece una experiencia potenciada en Arkania y es el mejor uso de tus monedas. ¡Aquí te dejo toda la información que necesitas!')
              .addFields(
                { name: '🤔 ¿Cómo lo adquiero?', value: '1. En la tienda de monedas.\n2. Como regalo de otro miembro.\n3. Como premio en algún sorteo o evento.\n4.Boosteando el servidor.\nLo puedes encontrar en dos duraciones (7d, 15d).', inline: true },
                { name: '✨ Beneficios', value: '1. Un extra en el ingreso diario.\n2. Destacar tu nombre en la lista de conectados.\n3. El **doble** de entrada en los sorteos.\n4. Un **25%** extra de experiencia.\n5. Mover o desconectar miembros de los canales de voz.', inline: true },
                { name: '🔮 Futuro', value: 'Constantemente evaluamos la posibilidad de añadir nuevos beneficios al rol, eso también suele aumentar el costo de monedas del mismo por lo que almacena bien tus monedas y ¡vuelve un VIP de Arkania!.' }
              )
            break;
